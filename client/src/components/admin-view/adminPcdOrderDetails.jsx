...
function AdminPcdOrderDetailsView({ orderDetails }) {
 ...
 const handleUpdateDeliveryBoy = () => {
  ...
  dispatch(
    ...
    if (data?.payload?.success) {
      ...
      // ✅ Add delivery alert of type "pcdorders"
      dispatch(
  ...
  const handleUpdateStatus = (event) => {
    ...
    dispatch(
      updatePcdOrderStatus({ id: orderDetails?._id, orderStatus: status })
    ).then((data) => {
      if (data?.payload?.success) {
        dispatch(getPcdOrderDetailsForAdmin(orderDetails?._id));
        dispatch(getAllPcdOrdersForAdmin());
          ...
          <div className="flex mt-2 items-center justify-between">
            ...
            <Label className="flex items-center gap-2">
              <Input
                ...
                className="w-24"
              />
              <Button onClick={handleUpdateTotalAmount} className="bg-green-500 text-white hover:bg-green-600">
                Add
              </Button>
            </Label>
          </div>
            ...
            formControls={[
              {
                ...
                options: [
                  ...
                  { id: "Outfor_delivery", label: "Out For Delivery" },
...
export default AdminPcdOrderDetailsView;